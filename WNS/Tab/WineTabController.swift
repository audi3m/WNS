...
final class WineTabController: UITabBarController, UITabBarControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let testTab = UINavigationController(rootViewController: SettingsViewController())
        ...
        addNew.tabBarItem = UITabBarItem(title: "", image: TabItemImage.addNew.selectedImage, tag: 2)
